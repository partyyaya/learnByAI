...
- 用 `SQLx` / `SeaORM` 串接資料庫，處理連線池、Migration、CRUD 與交易（資料庫串接）。
...
如果你已經熟悉 Rust 語法，可以直接從第 09 章的架構設計開始，再往 10、11、12 走，做完第 13 章成品後，再用第 14 章把它強化成能扛流量尖峰、擋得住故障的生產級服務。
