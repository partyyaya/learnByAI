...
| 09 | [09-spring-boot-3-and-pitfalls.md](./09-spring-boot-3-and-pitfalls.md) | Spring Boot 3 與常見雷點 | Jakarta 命名空間遷移、設定變更清單、啟動變慢、Bean 找不到的除錯流程 |
...
**第 00～09 章全部完成**（含每章的驗收清單與附解答練習）。這一站已結業，下一站是 [03-rest-api](../03-rest-api/)。

| 章節 | 狀態 | 篇幅 |
|------|------|------|
| 00 課程地圖與 Spring Boot 定位 | ✅ 完成 | 約 1,600 行 |
| 01 IoC 容器與依賴注入 | ✅ 完成 | 約 3,200 行 |
| 02 自動組態原理 | ✅ 完成 | 約 2,500 行 |
| 03 設定檔與多環境 | ✅ 完成 | 約 3,100 行 |
| 04 AOP 與代理機制 | ✅ 完成 | 約 3,200 行 |
| 05 日誌與可觀測性 | ✅ 完成 | 約 3,100 行 |
| 06 排程、非同步與事件 | ✅ 完成 | 約 3,300 行 |
| 07 Spring Boot 測試策略 | ✅ 完成 | 約 2,900 行 |
| 08 打包與部署 | ✅ 完成 | 約 2,900 行 |
| 09 Spring Boot 3 與常見雷點 | ✅ 完成 | 約 3,200 行 |
